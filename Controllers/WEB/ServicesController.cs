...
namespace AlimBio.Controllers.WEB
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Couleur,Icon,NomService,Description,SiteId,EntrepriseId")] Service service)
        {
            ...
            ViewData["EntrepriseId"] = new SelectList(_context.Entreprises, "Id", "Id", service.EntrepriseId);
            ViewData["SiteId"] = new SelectList(_context.Sites, "Id", "Id", service.SiteId);
            return View(service);
        }
